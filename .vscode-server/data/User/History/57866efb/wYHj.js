    ...
    try{
     request.get({
        ...
        if(err){
            ...
            var total = data.result.content[0]
            var love = data.result.content[1]
            var worth = data.result.content[2]
            var work = data.result.content[3]
            var test = data.result.content[4]
