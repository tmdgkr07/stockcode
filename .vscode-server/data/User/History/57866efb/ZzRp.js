    ...
    try{
     request.get({
        ...
        if(err){
            ...
            var total = data.result.date.content[0]
            var love = data.result.date.content[1]
            var worth = data.result.date.content[2]
            var work = data.result.date.content[3]
            var test = data.result.date.content[4]
