    ...
    try{
     request.get({
        ...
        if(err){
           ...
           // console.log(data[1])
            var data2= data3[1].slice(0,-2).result
            console.log(data2)
            var total = data2.result.day.content[0]
            var love = data2.result.day.content[1]
            var worth = data2.result.day.content[2]
            var work = data2.result.day.content[3]
            var test = data2.result.day.content[4]
