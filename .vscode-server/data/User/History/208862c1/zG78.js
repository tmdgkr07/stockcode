...
const nasdaq = JSON.parse(fs.readFileSync("./INFO/NASMST.json", 'utf-8'));
const nyse = JSON.parse(fs.readFileSync('./INFO/NYSMST.json', 'utf-8'));
const amex = JSON.parse(fs.readFileSync('./INFO/AMSMST.json', 'utf-8'));
...
const nasdaq_key = Object.keys(nasdaq);
const nasdaq_value = Object.values(nasdaq);
const nasdaq_name = nasdaq_key.concat(nasdaq_value)
...
let stock = JSON.parse(fs.readFileSync('./INFO/stock.json', 'utf-8'));
let stock_name = Object.values(stock);
// let stock_value = Object.values(stock);
// let stock_name = stock_name23.concat(stock_value);
    ...
    if(amexQueue.length > 0){
      ...
      await request.get({
        ...
        'Referer': 'http://m.stock.naver.com'}
          ...
          var price_status = data.compareToPreviousPrice.name
          var changerate = data.fluctuationsRatio
          var nasdaq_find = fs.readFileSync('./INFO/AMSMST.json', 'utf-8');
      ...
      if(nyseQueue.length > 0){
        ...
        request.get({
          ...
          if(err) {
            ...
            var price_status = data.compareToPreviousPrice.name
            var changerate = data.fluctuationsRatio
            var nasdaq_find = fs.readFileSync('./INFO/NYSMST.json', 'utf-8');
            var stock_name2 = JSON.parse(nasdaq_find)
    ...
    if (nasdaqQueue.length > 0){
      ...
      request.get({
        ...
        if(err) {
          ...
          var price_status = data.compareToPreviousPrice.name
          var changerate = data.fluctuationsRatio
          var nasdaq_find = fs.readFileSync('./INFO/NASMST.json', 'utf-8');
          var stock_name2 = JSON.parse(nasdaq_find)
